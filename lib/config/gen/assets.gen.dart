...
class $AssetsSvgGen {
  ...
  SvgGenImage get whatsappOutline =>
      const SvgGenImage('assets/svg/whatsapp-outline.svg');

  /// List of all assets
  List<SvgGenImage> get values => [send, whatsappOutline];
}
...
class Assets {
  ...
  static const AssetGenImage addOnlyBlack =
      AssetGenImage('assets/add-Only-black.png');
  ...
  static const AssetGenImage wtspAppIcon =
      AssetGenImage('assets/wtsp-app_icon.png');
