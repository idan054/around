        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              ...
              final sendToAdmin = isAdMode || (age <= 24 && age >= 17);

              openWhatsapp(context,
                  whatsapp: sendToAdmin ? '+972584770076' : phone, text: '''
...
הגיל שלי הוא ${user.age} ${isAdMode ? 'ואני ממש אשמח להצטרף (:' : 'ואשמח להצטרף!'}''');
              ...
              if (!kDebugMode) printTrackEvent('isAdMode $isAdMode', properties: {});
...
void printTrackEvent(String string, {required Map<String, dynamic> properties}) {
}
